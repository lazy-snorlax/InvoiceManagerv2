    ...
    <page size="A4" class="page-break">
        <div class="content">
            <table width="100%" style="margin-bottom: 10px">
                <tr>
                    ...
                    <td style="text-align: center">
                        <h1 style="margin-bottom: 3px">TAX INVOICE</h1>
            ...
            <table width="100%" style="margin-bottom: 10px;">
                <tr>
                        ...
                        <table width="100%">
                            <tr>
                                <th style="vertical-align: top;">
                                    <span style="font-size: 10pt;">Invoice To:</span>
                                </th>
                    ...
                    <td>
                        <table width="100%">
                            <tr>
                                <th style="padding: left 5px; text-align: right">Invoice No: </th>
                                <td style="border: solid 1px gray;text-align: center">{{ $invoice->id }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="border: solid 1px gray;text-align: center">{{ $invoice->order_no }}</td>
                            </tr>
                            <tr>
                                <th style="padding: left 5px; text-align: right">Terms: </th>
            ...
            <table width="100%">
                ...
                @foreach ($invoice->headers as $head)
                    <tr>
